...
% Allow TeX more flexibility on lines containing long Mathlib references.
% Long \texttt{...} identifiers can't hyphenate, so we widen the emergency
% stretch and permit looser inter-word spacing as a fallback. Together with
% the per-identifier \allowbreak hints below, this clears almost all the
